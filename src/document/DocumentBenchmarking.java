	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			for (int i = 0; i < trials; ++i){
				BasicDocument basicTest = new BasicDocument(testString); 
				basicTest.getFleschScore();
			}
			long endTime = System.nanoTime();
			System.out.print((double)((endTime - startTime)/ 1000000) + "\t");
			startTime = System.nanoTime();
			for (int i = 0; i < trials; ++i){
				EfficientDocument effiTest = new EfficientDocument(testString); 
				effiTest.getFleschScore();
			}
